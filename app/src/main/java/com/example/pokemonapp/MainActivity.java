            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    for(int j = 0; j < jsonObject1.getJSONArray("type").length(); j++) {
                        type.add(jsonObject1.getJSONArray("type").getString(0));
                        break;
                    }
    ...
    public void setAdapter(final ArrayList<Pokemon> pokemons) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("image", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/" + pokemons.get(position).getId() + ".gif");
